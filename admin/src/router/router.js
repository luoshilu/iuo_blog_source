...
export const adminRouter = [{
  ...
  children: [
    ...
    { path: 'demo/save', name: 'DemoSave', meta: { title: 'demo编辑', requiresAuth: true }, component: resolve => { require(['@/view/demo/save.vue'], resolve) } },
    { path: 'demo/list', name: 'DemoSave', meta: { title: 'demo列表', requiresAuth: true }, component: resolve => { require(['@/view/demo/list.vue'], resolve) } },
